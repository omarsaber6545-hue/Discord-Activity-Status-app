        ...
        when (intent?.action) {
            ...
            ACTION_UPDATE_PRESENCE -> {
                ...
                gatewayClient?.updatePresence(
                    ...
                    secondaryEnableDetails = prefs.secondaryEnableDetails,
                    secondaryDetails = prefs.secondaryDetails,
                    secondaryEnableState = prefs.secondaryEnableState,
                    secondaryState = prefs.secondaryState,
                    secondaryEnableAfk = prefs.secondaryEnableAfk,
                    secondaryShowTimer = prefs.secondaryShowTimer,
